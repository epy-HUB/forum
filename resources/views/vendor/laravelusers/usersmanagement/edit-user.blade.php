          ...
          {!! Form::open(array('route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form')) !!}
            ...
            <div class="panel-footer">
              <div class="row">
                ...
                <div class="col-xs-6">
                  {!! Form::button(trans('laravelusers::forms.save-changes'), array('class' => 'btn btn-success btn-block margin-bottom-1 btn-save','type' => 'button', 'data-toggle' => 'modal', 'data-target' => '#confirmSave', 'data-title' => trans('Confirm Save'), 'data-message' => trans('Please confirm your changes'))) !!}
                </div>
